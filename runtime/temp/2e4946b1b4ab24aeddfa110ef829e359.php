<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"D:\www\11_27_ddsc\public/../application/admin\view\shops\modifys.html";i:1543800474;s:59:"D:\www\11_27_ddsc\application\admin\view\public\header.html";i:1536572465;s:56:"D:\www\11_27_ddsc\application\admin\view\public\nav.html";i:1534735680;s:57:"D:\www\11_27_ddsc\application\admin\view\public\left.html";i:1543566288;s:56:"D:\www\11_27_ddsc\application\admin\view\public\set.html";i:1531125003;s:59:"D:\www\11_27_ddsc\application\admin\view\public\footer.html";i:1535074403;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="col-sm-10 col-sm-offset-1">
              <form id="logoForm" class="form-horizontal" action="<?php echo url('Shops/usave'); ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-sm-7">
                    <div class="widget-box transparent">
                      <div class="widget-header widget-header-flat">
                        <h4 class="widget-title"><i class="ace-icon fa fa-leaf green"></i>店铺信息</h4>
                      </div>
                      <div class="widget-body">
                        <div class="widget-main">
                          <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right" for="">店铺名称</label>
                            <div class="col-sm-10">
                              <input class="form-control" type="text" name="shop_name" value="<?php echo $re['shop_name']; ?>" required>
                            </div>
                          </div>
                           ...
                           <label class="col-sm-2 control-label no-padding-right" for="">状态</label>
                            <div class="col-sm-2">
                              <label style="padding-top: 8px">
                                <input name="shop_status" class="ace ace-switch ace-switch-6" type="checkbox" <?php if($re['shop_status'] == 1): ?> checked <?php endif; ?> />
                                <span class="lbl"></span>
                              </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                              <label style="padding-top: 8px">
                                <input name="shop_groom" class="ace ace-switch ace-switch-6" type="checkbox" <?php if($re['shop_groom'] == 1): ?> checked <?php endif; ?>  />
                                <span class="lbl"></span>
                              </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                              <input class="input-small" name="shop_sort" type="number" value="<?php echo $re['shop_sort']; ?>">
                            </div>
                    ...
                    <div class="widget-box transparent">
                      ...
                      <div class="widget-body">
                        <div class="widget-main">
                          <div class="form-group">
                            <div class="col-xs-12">
                              <input multiple="" type="file" id="shop_logo_index" name="shop_logo_index"/>
                              <img src="<?php echo $re['shop_logo_index']; ?>" class="img-responsive" />
                            </div>
                          </div>
                          
                          <div class="form-group">
                            <div class="col-xs-12">
                              <input multiple="" type="file" id="shop_logo" name="shop_logo"/>
                              <img src="<?php echo $re['shop_logo']; ?>" class="img-responsive" />
                            </div>
                          </div>
                          
                          <div class="form-group">
                            <div class="col-xs-12">
                              <input multiple="" type="file" id="shop_image" name="shop_image"/>
                              <img src="<?php echo $re['shop_image']; ?>" class="img-responsive" />
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <script src="/static/admin/assets/js/ueditor.config.js" type="text/javascript"></script>
                    <script src="/static/admin/assets/js/ueditor.all.js" type="text/javascript"></script>
                    <textarea id="myEditor" name="shop_content" style="width:100%;"><?php echo $re['shop_content']; ?></textarea>
                    <script type="text/javascript">
                ...
                <div class="clearfix form-actions">
                  <div class="col-md-offset-3 col-md-9">
                   <input name="shop_id" type="hidden" value="<?php echo $re['shop_id']; ?>" />
...
<script>
  ...
  <script>
    $(function () {
      $('#shop_logo_index').ace_file_input({
        style: 'well',
        btn_choose: '首页logo',
        btn_change: null,
