          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="alert alert-block alert-success">
                ...
                欢迎使用
                <strong class="green">
                  <a href="http://www.toopen.cn" target="_blank">朵朵科技</a>后台管理系统
                  <small>(v1.1)</small>
                </strong>,
                轻量级好用的后台管理系统
              </div>
