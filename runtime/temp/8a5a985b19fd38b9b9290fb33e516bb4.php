<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"D:\www\11_27_ddsc\public/../application/admin\view\shops\lister.html";i:1543807534;s:59:"D:\www\11_27_ddsc\application\admin\view\public\header.html";i:1536572465;s:56:"D:\www\11_27_ddsc\application\admin\view\public\nav.html";i:1534735680;s:57:"D:\www\11_27_ddsc\application\admin\view\public\left.html";i:1543566288;s:56:"D:\www\11_27_ddsc\application\admin\view\public\set.html";i:1531125003;s:59:"D:\www\11_27_ddsc\application\admin\view\public\footer.html";i:1535074403;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
$(function(){
  ...
  <ul class="nav nav-list">
    ...
    <?php if(CONTROLLER_NAME == 'About'): ?><li class="open"><?php else: ?><li class=""><?php endif; ?>
      <a href="#" class="dropdown-toggle">
        <i class="menu-icon fa fa-map-signs"></i>
        <span class="menu-text"> 集团介绍</span>
      ...
      <ul class="submenu">
       ...
       <?php if(ACTION_NAME == 'speak'): ?><li class="active"><?php else: ?><li class=""><?php endif; ?>
          <a href="<?php echo url('About/speak'); ?>">
            <i class="menu-icon fa fa-caret-right"></i>
            总裁致辞
          </a>
        ...
        <?php if(ACTION_NAME == 'honor'): ?><li class="active"><?php else: ?><li class=""><?php endif; ?>
          <a href="<?php echo url('About/honor'); ?>">
            <i class="menu-icon fa fa-caret-right"></i>
            资质荣誉
          </a>
        ...
        <?php if(ACTION_NAME == 'ideal'): ?><li class="active"><?php else: ?><li class=""><?php endif; ?>
          <a href="<?php echo url('About/ideal'); ?>">
            <i class="menu-icon fa fa-caret-right"></i>
            集团理念
          </a>
          
          <?php if(ACTION_NAME == 'type'): ?><li class="active"><?php else: ?><li class=""><?php endif; ?>
          <a href="<?php echo url('About/type'); ?>">
            <i class="menu-icon fa fa-caret-right"></i>
            组织分类
          </a>
          <?php if(ACTION_NAME == 'lister'): ?><li class="active"><?php else: ?><li class=""><?php endif; ?>
          <a href="<?php echo url('About/lister'); ?>">
            <i class="menu-icon fa fa-caret-right"></i>
            组织列表
          </a>
       ...
       <?php if(CONTROLLER_NAME == 'Cases'): ?><li class="open"><?php else: ?><li class=""><?php endif; ?>
      <a href="#" class="dropdown-toggle">
      ...
      <ul class="submenu">
        <?php if(ACTION_NAME == 'lister'): ?><li class="active"><?php else: ?><li class=""><?php endif; ?>
          <a href="<?php echo url('Cases/lister'); ?>">
            <i class="menu-icon fa fa-caret-right"></i>
            产品列表
          </a>
     ...
     <?php if(ACTION_NAME == 'type'): ?><li class="active"><?php else: ?><li class=""><?php endif; ?>
          <a href="<?php echo url('Cases/type'); ?>">
            <i class="menu-icon fa fa-caret-right"></i>
            分类列表
          </a>
          ...
          <div class="col-xs-12">
            <div class="col-sm-10 col-sm-offset-1">
              <div class="page-header">
                <div class="row">
                <div class="col-sm-4">
                <a class="btn btn-success btn-white btn-bold" href="<?php echo url('Shops/add'); ?>">
              ...
              <table class="table table-bordered table-hover">
                ...
                <form id="sortForm" action="<?php echo url('Shops/sort'); ?>" method="post"> 
                <tbody>
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr class="ace-thumbnails">
                  <td class="center"><label class="pos-rel">
                    <input type="checkbox" class="ace check" value="<?php echo $v['shop_id']; ?>">
                    <span class="lbl"></span>
                  </label>
                  </td>
                  <td><span class="badge badge-grey"><?php echo $v['shop_id']; ?></span></td>
                  <td class="hidden-480"><input class="input-small" type="number" name="<?php echo $v['shop_id']; ?>" value="<?php echo $v['shop_sort']; ?>"></td>
                  <td><?php echo $v['shop_name']; ?></td>
                  <td class="ace-thumbnails hidden-480">
                    <li><a href="<?php echo $v['shop_logo_index']; ?>" data-rel="colorbox">
                      <img width="80" height="80" alt="150x150" src="<?php echo $v['shop_logo_index']; ?>"/>
                      <div class="text">
                  ...
                  <td class="ace-thumbnails hidden-480">
                    <li><a href="<?php echo $v['shop_logo']; ?>" data-rel="colorbox">
                      <img width="80" height="80" alt="150x150" src="<?php echo $v['shop_logo']; ?>"/>
                      <div class="text">
                        <div class="inner">点击放大</div>
                      </div>
                    </a></li>
                  ...
                  <td class="ace-thumbnails hidden-480">
                    <li><a href="<?php echo $v['shop_image']; ?>" data-rel="colorbox">
                      <img width="80" height="80" alt="150x150" src="<?php echo $v['shop_image']; ?>"/>
                      <div class="text">
                        <div class="inner">点击放大</div>
                      </div>
                    </a></li>
                  </td>
                  <td class="hidden-480"><?php echo date("Y-m-d H:i:s",$v['shop_time']); ?></td>
                  <td>
                    <label>
                      <input id="statu" name="status" onclick="change(<?php echo $v['shop_id']; ?>)" class="ace ace-switch ace-switch-6" type="checkbox" <?php if($v['shop_status'] == 1): ?>checked<?php endif; ?> />
                      <span class="lbl"></span>
                    </label>
                  </td>
                  <td>
                    <label>
                      <input id="statu" name="groom" onclick="changes(<?php echo $v['shop_id']; ?>)" class="ace ace-switch ace-switch-6" type="checkbox" <?php if($v['shop_groom'] == 1): ?>checked<?php endif; ?> />
                      <span class="lbl"></span>
                    </label>
                  </td>
                  <td>
                    <a class="btn btn-xs btn-info" href="<?php echo url('modifys',array('id'=>$v['shop_id'])); ?>">
                      <i class="ace-icon fa fa-pencil bigger-120"></i>
                    </a>
                    <button class="btn btn-xs btn-danger" type="button" onclick="dels(<?php echo $v['shop_id']; ?>)">
                      <i class="ace-icon fa fa-trash-o bigger-120"></i>
                    </button>
                  </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?><tr><td colspan="15" class="text-center">暂无数据</td></tr><?php endif; ?>
                </tbody>
                </form>
              </table>
...
<script type="text/javascript">
		function dels(id){
		    ...
		    layer.close(index);
		    window.location.href="<?php echo url('Shops/delete'); ?>?id/"+id;
		  });
	    }
		</script>
<script>
...
function changes(id){
	$.ajax({
		type:"post",
		url:"<?php echo url('Shops/changes'); ?>",
	    data:{id:id},
	    datatype:"text",
	    success:function(){
